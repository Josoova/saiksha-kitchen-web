...
import { Star, Award, TrendingUp, Flame } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { gasStoveSpecs } from '@/data/products';
...
const Products = () => {
  const [activeTab, setActiveTab] = useState<GasStoveCategory>('2b');
  ...
  const handleProductClick = (productId: string) => {
    navigate(`/products/gas-stoves/${productId}`);
  };
  ...
  const renderGasStoveSpec = (spec: any) => (
    <Card 
      ...
      onClick={() => handleProductClick(spec.id)}
    >
    ...
    <div className="relative min-h-screen">
        ...
        <div className="container mx-auto px-4 text-center relative z-20">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-shadow animate-scale-in">
              Premium Gas Stove Collection
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto animate-fade-in leading-relaxed" style={{animationDelay: "300ms"}}>
              Discover our complete range of 2B, 3B, and 4B gas stoves with PC and SS frame options.
            </p>
      ...
      <section className="py-20 relative z-10 bg-gradient-to-b from-white via-gray-50 to-green-50">
        <div className="container mx-auto px-4">
          <Tabs defaultValue="2b" className="w-full" onValueChange={(value) => setActiveTab(value as GasStoveCategory)}>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="bg-white p-10 rounded-3xl shadow-2xl transform hover:-translate-y-2 transition-all border border-gray-100 max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 text-gray-700 leading-relaxed">
              We provide comprehensive after-sales support for all our gas stoves. 
